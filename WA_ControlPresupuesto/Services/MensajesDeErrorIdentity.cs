...
namespace WA_ControlPresupuesto.Services
{
    ...
    {
        //Cuando hacemos override, estamos sobreescribiendo el método de la clase base (IdentityErrorDescriber) para personalizar los mensajes de error que se muestran al usuario. En este caso, los mensajes de error los pasamos español.
